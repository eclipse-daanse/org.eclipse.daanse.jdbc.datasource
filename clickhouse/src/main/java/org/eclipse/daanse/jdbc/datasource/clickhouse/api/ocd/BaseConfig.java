...
*/
package org.eclipse.daanse.jdbc.datasource.clickhouse.api.ocd;
...
public interface BaseConfig {
    ...
    String OCD_LOCALIZATION = "OSGI-INF/l10n/org.eclipse.daanse.jdbc.datasource.clickhouse.ocd";
    String L10N_PREFIX = "%";
    ...
    String L10N_CUSTOM_SETTINGS_NAME = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_CUSTOM_SETTINGS + L10N_POSTFIX_NAME;
    String L10N_CUSTOM_SETTINGS_DESCRIPTION = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_CUSTOM_SETTINGS
            + L10N_POSTFIX_DESCRIPTION;

    // Default value constants
    String DEFAULT_PASSWORD = "";
    String DEFAULT_USER = "";
    int DEFAULT_PORT_NUMBER = 8123;
    String DEFAULT_DATABASE_NAME = "";
    String DEFAULT_SERVER_NAME = "localhost";
    String DEFAULT_CUSTOM_SETTINGS = "";
    ...
    @AttributeDefinition(name = L10N_CUSTOM_SETTINGS_NAME, description = L10N_CUSTOM_SETTINGS_DESCRIPTION, defaultValue = DEFAULT_CUSTOM_SETTINGS)
