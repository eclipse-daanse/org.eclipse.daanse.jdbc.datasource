...
*/
package org.eclipse.daanse.jdbc.datasource.mysql.api;
...
public class Constants {
     ...
     */
    public static final String PID_DATASOURCE = "daanse.jdbc.datasource.mysql.DataSource";

    /**
     * Constant for the {@link org.osgi.framework.Constants#SERVICE_PID} of a
     * {@link ConnectionPoolDataSource} - Service.
     */
    public static final String PID_DATASOURCE_CP = "daanse.jdbc.datasource.mysql.ConnectionPoolDataSource";

    /**
     * Constant for the {@link org.osgi.framework.Constants#SERVICE_PID} of a {@link XADataSource} -
     * Service.
     */
    public static final String PID_DATASOURCE_XA = "daanse.jdbc.datasource.mysql.XADataSource";

    /**
     * Constant for Properties of the Service that could be configured.
     *
     * {@link org.eclipse.daanse.jdbc.datasource.mysql.api.ocd.BaseConfig#_password()}
     */
     ...
     * Constant for Properties of the Service that could be configured.
     *
     * {@link org.eclipse.daanse.jdbc.datasource.mysql.api.ocd.BaseConfig#user()}
     */
     ...
     * Constant for Properties of the Service that could be configured.
     *
     * {@link org.eclipse.daanse.jdbc.datasource.mysql.api.ocd.BaseConfig#host()}
     */
     ...
     * Constant for Properties of the Service that could be configured.
     *
     * {@link org.eclipse.daanse.jdbc.datasource.mysql.api.ocd.BaseConfig#databaseName()}
     */
     ...
     * Constant for Properties of the Service that could be configured.
     *
     * {@link org.eclipse.daanse.jdbc.datasource.mysql.api.ocd.BaseConfig#port()}
     */
