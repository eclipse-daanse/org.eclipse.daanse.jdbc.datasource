...
import org.eclipse.daanse.jdbc.datasource.mariadb.api.ocd.XaDsConfig;
...
@Component(service = XADataSource.class, scope = ServiceScope.SINGLETON, configurationPid = Constants.PID_XA_DATASOURCE)
