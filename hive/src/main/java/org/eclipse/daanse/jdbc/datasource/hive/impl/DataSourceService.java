...
import org.eclipse.daanse.jdbc.datasource.hive.api.ocd.DsConfig;
...
public class DataSourceService extends AbstractDataSource {
    ...
    public DataSourceService(Map<String, Object> configMap) throws SQLException {
        ...
        try {
            ...
            LOGGER.error("Failed to configure Hive DataSource with config: {}", safeConfigMap, e);
