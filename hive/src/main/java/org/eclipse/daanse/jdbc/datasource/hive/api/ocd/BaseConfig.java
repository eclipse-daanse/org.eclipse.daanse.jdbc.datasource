...
*/
package org.eclipse.daanse.jdbc.datasource.hive.api.ocd;
...
public interface BaseConfig {
    ...
    String OCD_LOCALIZATION = "OSGI-INF/l10n/org.eclipse.daanse.jdbc.datasource.hive.ocd";
    String L10N_PREFIX = "%";
    ...
    String L10N_SSL_NAME = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_SSL + L10N_POSTFIX_NAME;
    String L10N_SSL_DESCRIPTION = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_SSL + L10N_POSTFIX_DESCRIPTION;

    String L10N_SESSION_CONF_NAME = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_SESSION_CONF + L10N_POSTFIX_NAME;
    String L10N_SESSION_CONF_DESCRIPTION = L10N_PREFIX + Constants.DATASOURCE_PROPERTY_SESSION_CONF
            + L10N_POSTFIX_DESCRIPTION;

    // Default value constants
    String DEFAULT_PASSWORD = "";
    String DEFAULT_USER = "";
    int DEFAULT_PORT_NUMBER = 10000;
    String DEFAULT_DATABASE_NAME = "default";
    String DEFAULT_SERVER_NAME = "localhost";
    boolean DEFAULT_SSL = false;
    String DEFAULT_SESSION_CONF = "";
    ...
    @AttributeDefinition(name = L10N_SESSION_CONF_NAME, description = L10N_SESSION_CONF_DESCRIPTION, defaultValue = DEFAULT_SESSION_CONF)
    default String sessionConf() {
        return DEFAULT_SESSION_CONF;
    }
}
