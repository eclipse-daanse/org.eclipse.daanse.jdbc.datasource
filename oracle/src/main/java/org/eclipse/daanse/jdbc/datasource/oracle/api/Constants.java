...
*/
package org.eclipse.daanse.jdbc.datasource.oracle.api;
...
public class Constants {
     ...
     */
    public static final String PID_DATASOURCE = "daanse.jdbc.datasource.oracle.DataSource";

    /**
     * Constant for the {@link org.osgi.framework.Constants#SERVICE_PID} of a
     * {@link ConnectionPoolDataSource} - Service.
     */
    public static final String PID_DATASOURCE_CP = "daanse.jdbc.datasource.oracle.ConnectionPoolDataSource";

    /**
     * Constant for the {@link org.osgi.framework.Constants#SERVICE_PID} of a {@link XADataSource} -
     * Service.
     */
    public static final String PID_DATASOURCE_XA = "daanse.jdbc.datasource.oracle.XADataSource";
