...
*/
package org.eclipse.daanse.jdbc.datasource.opensearch;
...
class OSDataSourceTest {
    ...
    @Disabled
    @Test
    @WithFactoryConfiguration(factoryPid = org.eclipse.daanse.jdbc.datasource.opensearch.api.Constants.PID_DATASOURCE, name = "1", location = "?", properties = {
